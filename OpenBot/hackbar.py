...
class OpenBotHackbarDialog(ui.ScriptWindow): 				
    ...
    def __init__(self):
        ...
        self.GhostButton = self.comp.HideButton(None, '', 'Ghostmod', wndMgr.GetScreenWidth()-115, 310, self.GhostMod, eXLib.PATH + 'OpenBot/Images/Shortcuts/ghost_0.tga', eXLib.PATH + 'OpenBot/Images/Shortcuts/ghost_1.tga', eXLib.PATH + 'OpenBot/Images/Shortcuts/ghost_0.tga')
        ...
        self.GoForward = self.comp.HideButton(None, '', '', wndMgr.GetScreenWidth()-230, 0, lambda : self.TeleportInDirection(1), eXLib.PATH + 'OpenBot/Images/Shortcuts/Arrow/tele_up_0.tga', eXLib.PATH + 'OpenBot/Images/Shortcuts/Arrow/tele_up_1.tga', eXLib.PATH + 'OpenBot/Images/Shortcuts/Arrow/tele_up_0.tga')
        ...
        if DEBUG:
            self.MiningBotButton = self.comp.Button(self.OpenBotBoard, '', 'MiningBot', 8, 570, self.MiningBot, eXLib.PATH + 'OpenBot/Images/Hackbar/ore_slot_0.tga', eXLib.PATH + 'OpenBot/Images/Hackbar/ore_slot_1.tga', eXLib.PATH + 'OpenBot/Images/Hackbar/ore_slot_0.tga')
        ...
        self.networkButton = self.comp.Button(self.OpenBotBoard, '', 'network', 8, 533, self.OnNetworkButton, eXLib.PATH + 'OpenBot/Images/Hackbar/action_0.tga', eXLib.PATH + 'OpenBot/Images/Hackbar/action_1.tga', eXLib.PATH + 'OpenBot/Images/Hackbar/action_0.tga')
