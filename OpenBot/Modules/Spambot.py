...
class SpamDialog(ui.ScriptWindow):
	...
	def __init__(self):
		...
		self.SpamOn = self.comp.HideButton(self.Board, '', '', 80, 190, self.SetSpamStatus, eXLib.PATH + 'OpenBot/Images/start_0.tga', eXLib.PATH + 'OpenBot/Images/start_1.tga', eXLib.PATH + 'OpenBot/Images/start_2.tga')
		self.SpamOff = self.comp.HideButton(self.Board, '', '', 75, 190, self.SetSpamStatus, eXLib.PATH + 'OpenBot/Images/stop_0.tga', eXLib.PATH + 'OpenBot/Images/stop_1.tga', eXLib.PATH + 'OpenBot/Images/stop_2.tga')
