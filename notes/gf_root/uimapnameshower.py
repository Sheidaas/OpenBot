...
class MapNameShower(ui.ExpandedImageBox):
	...
	def __init__(self):
		...
		if app.ENABLE_GUILDRENEWAL_SYSTEM:
			self.MAP_NAME_IMAGE["metin2_map_guildwar_0"] = LOCALE_PATH + "war1.tga"
			self.MAP_NAME_IMAGE["metin2_map_guildwar_1"] = LOCALE_PATH + "war2.tga"
			self.MAP_NAME_IMAGE["metin2_map_guildwar_2"] = LOCALE_PATH + "war3.tga"
			self.MAP_NAME_IMAGE["metin2_map_guildwar_3"] = LOCALE_PATH + "war4.tga"
			self.MAP_NAME_IMAGE["metin2_map_guildwar_4"] = LOCALE_PATH + "war5.tga"						
